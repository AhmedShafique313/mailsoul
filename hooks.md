...
- Everytime .claude folder save its memory before ending the session and read the memory from the .claude folder on every session start to know the context we are working on.
