              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-sm font-medium text-emerald-200">
                    You&apos;re in, {name.split(" ")[0] || "there"}. We&apos;ll
                    email {email} the moment your inbox is ready.
                  </p>
                </motion.div>
              ) : (
                <motion.form
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    type="submit"
                    className="group mt-1 inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-violet-500 to-cyan-400 px-6 py-2.5 text-sm font-semibold text-black shadow-lg shadow-violet-500/30"
                  >
                    Create my account
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      type="button"
                      className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-zinc-200 transition-colors hover:bg-white/10"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-zinc-200 transition-colors hover:bg-white/10"
                    >
                      <span className="h-2.5 w-2.5 rounded-full bg-gradient-to-br from-blue-400 to-sky-300" />
                      Outlook
                    </button>
                  </div>
                </motion.form>
